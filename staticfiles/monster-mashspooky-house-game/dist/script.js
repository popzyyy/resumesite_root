...

{
    ...
    var Game = function() {
        ...
        this.levels = [
            ...
            { //Level 1 - Mummies
                enemiesToKill: 10,
                story: ("Your mission is to destroy 10 morbid mummies"),
                bullets: 2,
                enemyPoints: 10,
                cointPoints: 10,
            ...
            { //Level 2 - Grims
                enemiesToKill: 10,
                story: ("Well done!!\nYour next mission is to destroy 10 grisly grims"),
                bullets: 2,
                enemyPoints: 20,
                cointPoints: 10,
            ...
            { //Level 3 - Werewolves
                enemiesToKill: 15,
                story: ("Awesome!!\nWatch out for those 15 wild werewolves"),
                bullets: 2,
                enemyPoints: 30,
                cointPoints: 15,
            ...
            { //Level 5 - Skeletons
                enemiesToKill: 15,
                story: ("Amazing stuff!!\nBring on the 15 scary skeletons"),
                bullets: 3,
                enemyPoints: 50,
                cointPoints: 20,
            ...
            { //Level 7 - Ghosts
                enemiesToKill: 15,
                story: ("Excellent!!\nTime to destroy 15 ghoulish ghosts"),
                bullets: 4,
                enemyPoints: 100,
                cointPoints: 25,
            ...
            { //Level 8 - Cats
                enemiesToKill: 25,
                story: ("Awesome work!!\nAwe look at those cute... 25 creepy cats"),
                bullets: 4,
                enemyPoints: 150,
                cointPoints: 25,
                groundColors: [color(82, 47, 30), color(29, 29, 29), color(38, 38, 38), color(50, 50, 50), color(38, 38, 38)]
            ...
            { //Level 9 - Vampires
                enemiesToKill: 30,
                story: ("Almost there!!\nSay hello to... 30 vicious vampires"),
                bullets: 5,
                enemyPoints: 200,
                cointPoints: 25,
                groundColors: [color(119,22,22), color(29, 29, 29), color(38, 38, 38), color(50, 50, 50), color(38, 38, 38)]
            ...
            { //Level 10 - All Together
                enemiesToKill: 30,
                story: ("Superb!!\nYour final mission is to destroy 30 monsterous monsters"),
                bullets: 8,
                enemyPoints: 250,
                cointPoints: 50,
                groundColors: [color(119,22,22), color(29, 29, 29), color(38, 38, 38), color(50, 50, 50), color(38, 38, 38)]
    ...
    Game.prototype.home = function() {
        ...
        textSize(40);
        text("MONSTER MASH", width/2, 18);
        textSize(30);
        text("Spooky House", width/2, 60);
